 ...
 *******************************************************************************/
package org.eclipse.sme.frsl.ui.contentassist.antlr;
...
public class FRSLParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.eclipse.sme.frsl.ui.contentassist.antlr.internal.InternalFRSLParser createParser() {
		org.eclipse.sme.frsl.ui.contentassist.antlr.internal.InternalFRSLParser result = new org.eclipse.sme.frsl.ui.contentassist.antlr.internal.InternalFRSLParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getStepCSAccess().getAlternatives_0(), "rule__StepCS__Alternatives_0");
					put(grammarAccess.getActStepCSAccess().getAlternatives(), "rule__ActStepCS__Alternatives");
					put(grammarAccess.getSnapshotPatternCSAccess().getAlternatives_3_0(), "rule__SnapshotPatternCS__Alternatives_3_0");
					...
					put(grammarAccess.getFrslModelCSAccess().getGroup(), "rule__FrslModelCS__Group__0");
					put(grammarAccess.getUsecaseCSAccess().getGroup(), "rule__UsecaseCS__Group__0");
					put(grammarAccess.getUsecaseCSAccess().getGroup_2(), "rule__UsecaseCS__Group_2__0");
					put(grammarAccess.getUsecaseCSAccess().getGroup_6(), "rule__UsecaseCS__Group_6__0");
					put(grammarAccess.getUsecaseCSAccess().getGroup_6_4(), "rule__UsecaseCS__Group_6_4__0");
					put(grammarAccess.getUsecasePreconditionCSAccess().getGroup(), "rule__UsecasePreconditionCS__Group__0");
					put(grammarAccess.getUsecasePreconditionCSAccess().getGroup_1(), "rule__UsecasePreconditionCS__Group_1__0");
					put(grammarAccess.getUsecasePostconditionCSAccess().getGroup(), "rule__UsecasePostconditionCS__Group__0");
					put(grammarAccess.getUsecasePostconditionCSAccess().getGroup_1(), "rule__UsecasePostconditionCS__Group_1__0");
					put(grammarAccess.getStepCSAccess().getGroup(), "rule__StepCS__Group__0");
					put(grammarAccess.getActorStepCSAccess().getGroup(), "rule__ActorStepCS__Group__0");
					put(grammarAccess.getActorStepCSAccess().getGroup_2(), "rule__ActorStepCS__Group_2__0");
					put(grammarAccess.getActorStepCSAccess().getGroup_7(), "rule__ActorStepCS__Group_7__0");
					put(grammarAccess.getSystemStepCSAccess().getGroup(), "rule__SystemStepCS__Group__0");
					put(grammarAccess.getSystemStepCSAccess().getGroup_2(), "rule__SystemStepCS__Group_2__0");
					put(grammarAccess.getSystemStepCSAccess().getGroup_7(), "rule__SystemStepCS__Group_7__0");
					put(grammarAccess.getInputActionCSAccess().getGroup(), "rule__InputActionCS__Group__0");
					put(grammarAccess.getInputActionCSAccess().getGroup_2(), "rule__InputActionCS__Group_2__0");
					put(grammarAccess.getOutputActionCSAccess().getGroup(), "rule__OutputActionCS__Group__0");
					put(grammarAccess.getOutputActionCSAccess().getGroup_2(), "rule__OutputActionCS__Group_2__0");
					put(grammarAccess.getRejoinStepCSAccess().getGroup(), "rule__RejoinStepCS__Group__0");
					put(grammarAccess.getRejoinStepCSAccess().getGroup_2(), "rule__RejoinStepCS__Group_2__0");
					put(grammarAccess.getRejoinStepCSAccess().getGroup_3(), "rule__RejoinStepCS__Group_3__0");
					put(grammarAccess.getUCStepCSAccess().getGroup(), "rule__UCStepCS__Group__0");
					put(grammarAccess.getUCStepCSAccess().getGroup_2(), "rule__UCStepCS__Group_2__0");
					put(grammarAccess.getAltFlowCSAccess().getGroup(), "rule__AltFlowCS__Group__0");
					put(grammarAccess.getAltFlowCSAccess().getGroup_4(), "rule__AltFlowCS__Group_4__0");
					put(grammarAccess.getSnapshotPatternCSAccess().getGroup(), "rule__SnapshotPatternCS__Group__0");
					put(grammarAccess.getSnapshotPatternCSAccess().getGroup_1(), "rule__SnapshotPatternCS__Group_1__0");
					put(grammarAccess.getSnapshotPatternCSAccess().getGroup_2(), "rule__SnapshotPatternCS__Group_2__0");
					put(grammarAccess.getSnapshotPatternCSAccess().getGroup_3(), "rule__SnapshotPatternCS__Group_3__0");
					put(grammarAccess.getSnapshotPatternCSAccess().getGroup_4(), "rule__SnapshotPatternCS__Group_4__0");
					put(grammarAccess.getObjVarCSAccess().getGroup(), "rule__ObjVarCS__Group__0");
					put(grammarAccess.getNegObjVarCSAccess().getGroup(), "rule__NegObjVarCS__Group__0");
					put(grammarAccess.getVarLinkCSAccess().getGroup(), "rule__VarLinkCS__Group__0");
					put(grammarAccess.getAssociationCSAccess().getGroup(), "rule__AssociationCS__Group__0");
					put(grammarAccess.getConstraintCSAccess().getGroup(), "rule__ConstraintCS__Group__0");
					put(grammarAccess.getActorCSAccess().getGroup(), "rule__ActorCS__Group__0");
					put(grammarAccess.getActorCSAccess().getGroup_2(), "rule__ActorCS__Group_2__0");
					put(grammarAccess.getExtensionPointCSAccess().getGroup(), "rule__ExtensionPointCS__Group__0");
					put(grammarAccess.getExtensionPointCSAccess().getGroup_3(), "rule__ExtensionPointCS__Group_3__0");
					put(grammarAccess.getExtensionPointCSAccess().getGroup_3_3(), "rule__ExtensionPointCS__Group_3_3__0");
					put(grammarAccess.getExtensionPointCSAccess().getGroup_4(), "rule__ExtensionPointCS__Group_4__0");
					put(grammarAccess.getUcExtendCSAccess().getGroup(), "rule__UcExtendCS__Group__0");
					put(grammarAccess.getUcExtendCSAccess().getGroup_6(), "rule__UcExtendCS__Group_6__0");
					put(grammarAccess.getAssocEndCSAccess().getGroup(), "rule__AssocEndCS__Group__0");
					put(grammarAccess.getTypedTupeMultiplicityRefCSAccess().getGroup(), "rule__TypedTupeMultiplicityRefCS__Group__0");
					...
					put(grammarAccess.getFrslModelCSAccess().getDomainModelAssignment_0(), "rule__FrslModelCS__DomainModelAssignment_0");
					put(grammarAccess.getFrslModelCSAccess().getAssocsAssignment_1(), "rule__FrslModelCS__AssocsAssignment_1");
					put(grammarAccess.getFrslModelCSAccess().getActorsAssignment_2(), "rule__FrslModelCS__ActorsAssignment_2");
					put(grammarAccess.getFrslModelCSAccess().getUsecasesAssignment_3(), "rule__FrslModelCS__UsecasesAssignment_3");
					put(grammarAccess.getFrslModelCSAccess().getUcExtendsAssignment_4(), "rule__FrslModelCS__UcExtendsAssignment_4");
					put(grammarAccess.getUsecaseCSAccess().getNameAssignment_1(), "rule__UsecaseCS__NameAssignment_1");
					put(grammarAccess.getUsecaseCSAccess().getDescriptionAssignment_2_2(), "rule__UsecaseCS__DescriptionAssignment_2_2");
					put(grammarAccess.getUsecaseCSAccess().getPrimaryActorAssignment_5(), "rule__UsecaseCS__PrimaryActorAssignment_5");
					put(grammarAccess.getUsecaseCSAccess().getSecondaryActorsAssignment_6_3(), "rule__UsecaseCS__SecondaryActorsAssignment_6_3");
					put(grammarAccess.getUsecaseCSAccess().getSecondaryActorsAssignment_6_4_1(), "rule__UsecaseCS__SecondaryActorsAssignment_6_4_1");
					put(grammarAccess.getUsecaseCSAccess().getPreconditionAssignment_7(), "rule__UsecaseCS__PreconditionAssignment_7");
					put(grammarAccess.getUsecaseCSAccess().getPostconditionAssignment_8(), "rule__UsecaseCS__PostconditionAssignment_8");
					put(grammarAccess.getUsecaseCSAccess().getFirstStepAssignment_9(), "rule__UsecaseCS__FirstStepAssignment_9");
					put(grammarAccess.getUsecaseCSAccess().getExtPointsAssignment_10(), "rule__UsecaseCS__ExtPointsAssignment_10");
					put(grammarAccess.getUsecasePreconditionCSAccess().getDescriptionAssignment_1_2(), "rule__UsecasePreconditionCS__DescriptionAssignment_1_2");
					put(grammarAccess.getUsecasePreconditionCSAccess().getSnapshotAssignment_2(), "rule__UsecasePreconditionCS__SnapshotAssignment_2");
					put(grammarAccess.getUsecasePostconditionCSAccess().getDescriptionAssignment_1_2(), "rule__UsecasePostconditionCS__DescriptionAssignment_1_2");
					put(grammarAccess.getUsecasePostconditionCSAccess().getSnapshotAssignment_2(), "rule__UsecasePostconditionCS__SnapshotAssignment_2");
					put(grammarAccess.getStepCSAccess().getAltFlowsAssignment_1(), "rule__StepCS__AltFlowsAssignment_1");
					put(grammarAccess.getStepCSAccess().getNextStepAssignment_2(), "rule__StepCS__NextStepAssignment_2");
					put(grammarAccess.getActorStepCSAccess().getIsActorStepAssignment_0(), "rule__ActorStepCS__IsActorStepAssignment_0");
					put(grammarAccess.getActorStepCSAccess().getNameAssignment_1(), "rule__ActorStepCS__NameAssignment_1");
					put(grammarAccess.getActorStepCSAccess().getDescriptionAssignment_2_2(), "rule__ActorStepCS__DescriptionAssignment_2_2");
					put(grammarAccess.getActorStepCSAccess().getPreSnapshotAssignment_4(), "rule__ActorStepCS__PreSnapshotAssignment_4");
					put(grammarAccess.getActorStepCSAccess().getPostSnapshotAssignment_6(), "rule__ActorStepCS__PostSnapshotAssignment_6");
					put(grammarAccess.getActorStepCSAccess().getActionsAssignment_7_1(), "rule__ActorStepCS__ActionsAssignment_7_1");
					put(grammarAccess.getSystemStepCSAccess().getNameAssignment_1(), "rule__SystemStepCS__NameAssignment_1");
					put(grammarAccess.getSystemStepCSAccess().getDescriptionAssignment_2_2(), "rule__SystemStepCS__DescriptionAssignment_2_2");
					put(grammarAccess.getSystemStepCSAccess().getPreSnapshotAssignment_4(), "rule__SystemStepCS__PreSnapshotAssignment_4");
					put(grammarAccess.getSystemStepCSAccess().getPostSnapshotAssignment_6(), "rule__SystemStepCS__PostSnapshotAssignment_6");
					put(grammarAccess.getSystemStepCSAccess().getActionsAssignment_7_1(), "rule__SystemStepCS__ActionsAssignment_7_1");
					put(grammarAccess.getInputActionCSAccess().getActorAssignment_0(), "rule__InputActionCS__ActorAssignment_0");
					put(grammarAccess.getInputActionCSAccess().getObjVarsAssignment_2_0(), "rule__InputActionCS__ObjVarsAssignment_2_0");
					put(grammarAccess.getOutputActionCSAccess().getActorAssignment_0(), "rule__OutputActionCS__ActorAssignment_0");
					put(grammarAccess.getOutputActionCSAccess().getObjVarsAssignment_2_0(), "rule__OutputActionCS__ObjVarsAssignment_2_0");
					put(grammarAccess.getOutputActionCSAccess().getValuesAssignment_2_2(), "rule__OutputActionCS__ValuesAssignment_2_2");
					put(grammarAccess.getRejoinStepCSAccess().getRejoinToAssignment_1(), "rule__RejoinStepCS__RejoinToAssignment_1");
					put(grammarAccess.getRejoinStepCSAccess().getDescriptionAssignment_2_2(), "rule__RejoinStepCS__DescriptionAssignment_2_2");
					put(grammarAccess.getRejoinStepCSAccess().getConditionAssignment_3_1(), "rule__RejoinStepCS__ConditionAssignment_3_1");
					put(grammarAccess.getUCStepCSAccess().getNameAssignment_1(), "rule__UCStepCS__NameAssignment_1");
					put(grammarAccess.getUCStepCSAccess().getDescriptionAssignment_2_2(), "rule__UCStepCS__DescriptionAssignment_2_2");
					put(grammarAccess.getUCStepCSAccess().getIncludedUCAssignment_3(), "rule__UCStepCS__IncludedUCAssignment_3");
					put(grammarAccess.getAltFlowCSAccess().getNameAssignment_1(), "rule__AltFlowCS__NameAssignment_1");
					put(grammarAccess.getAltFlowCSAccess().getBaseStepAssignment_3(), "rule__AltFlowCS__BaseStepAssignment_3");
					put(grammarAccess.getAltFlowCSAccess().getDescriptionAssignment_4_2(), "rule__AltFlowCS__DescriptionAssignment_4_2");
					put(grammarAccess.getAltFlowCSAccess().getConditionAssignment_6(), "rule__AltFlowCS__ConditionAssignment_6");
					put(grammarAccess.getAltFlowCSAccess().getAltStepAssignment_8(), "rule__AltFlowCS__AltStepAssignment_8");
					put(grammarAccess.getSnapshotPatternCSAccess().getNameAssignment_1_2(), "rule__SnapshotPatternCS__NameAssignment_1_2");
					put(grammarAccess.getSnapshotPatternCSAccess().getDescriptionAssignment_2_2(), "rule__SnapshotPatternCS__DescriptionAssignment_2_2");
					put(grammarAccess.getSnapshotPatternCSAccess().getObjectsAssignment_3_0_0(), "rule__SnapshotPatternCS__ObjectsAssignment_3_0_0");
					put(grammarAccess.getSnapshotPatternCSAccess().getNegObjectsAssignment_3_0_1(), "rule__SnapshotPatternCS__NegObjectsAssignment_3_0_1");
					put(grammarAccess.getSnapshotPatternCSAccess().getLinksAssignment_4_0(), "rule__SnapshotPatternCS__LinksAssignment_4_0");
					put(grammarAccess.getSnapshotPatternCSAccess().getConstraintsAssignment_5(), "rule__SnapshotPatternCS__ConstraintsAssignment_5");
					put(grammarAccess.getObjVarCSAccess().getIsMatchedAssignment_0(), "rule__ObjVarCS__IsMatchedAssignment_0");
					put(grammarAccess.getObjVarCSAccess().getNameAssignment_1(), "rule__ObjVarCS__NameAssignment_1");
					put(grammarAccess.getObjVarCSAccess().getTypeAssignment_3(), "rule__ObjVarCS__TypeAssignment_3");
					put(grammarAccess.getVarLinkCSAccess().getIsNegAssignment_0(), "rule__VarLinkCS__IsNegAssignment_0");
					put(grammarAccess.getVarLinkCSAccess().getObjVarsAssignment_2(), "rule__VarLinkCS__ObjVarsAssignment_2");
					put(grammarAccess.getVarLinkCSAccess().getObjVarsAssignment_4(), "rule__VarLinkCS__ObjVarsAssignment_4");
					put(grammarAccess.getVarLinkCSAccess().getAssocAssignment_7(), "rule__VarLinkCS__AssocAssignment_7");
					put(grammarAccess.getAssociationCSAccess().getNameAssignment_1(), "rule__AssociationCS__NameAssignment_1");
					put(grammarAccess.getAssociationCSAccess().getAssocEndsAssignment_2(), "rule__AssociationCS__AssocEndsAssignment_2");
					put(grammarAccess.getAssociationCSAccess().getAssocEndsAssignment_3(), "rule__AssociationCS__AssocEndsAssignment_3");
					put(grammarAccess.getConstraintCSAccess().getConstrExprAssignment_1(), "rule__ConstraintCS__ConstrExprAssignment_1");
					put(grammarAccess.getActorCSAccess().getNameAssignment_1(), "rule__ActorCS__NameAssignment_1");
					put(grammarAccess.getActorCSAccess().getDescriptionAssignment_2_2(), "rule__ActorCS__DescriptionAssignment_2_2");
					put(grammarAccess.getExtensionPointCSAccess().getNameAssignment_2(), "rule__ExtensionPointCS__NameAssignment_2");
					put(grammarAccess.getExtensionPointCSAccess().getLocationsAssignment_3_2(), "rule__ExtensionPointCS__LocationsAssignment_3_2");
					put(grammarAccess.getExtensionPointCSAccess().getLocationsAssignment_3_3_1(), "rule__ExtensionPointCS__LocationsAssignment_3_3_1");
					put(grammarAccess.getExtensionPointCSAccess().getDescriptionAssignment_4_2(), "rule__ExtensionPointCS__DescriptionAssignment_4_2");
					put(grammarAccess.getExtensionPointCSAccess().getConditionAssignment_6(), "rule__ExtensionPointCS__ConditionAssignment_6");
					put(grammarAccess.getUcExtendCSAccess().getExtensionAssignment_0(), "rule__UcExtendCS__ExtensionAssignment_0");
					put(grammarAccess.getUcExtendCSAccess().getExtendedUCAssignment_2(), "rule__UcExtendCS__ExtendedUCAssignment_2");
					put(grammarAccess.getUcExtendCSAccess().getExtPointsAssignment_5(), "rule__UcExtendCS__ExtPointsAssignment_5");
					put(grammarAccess.getUcExtendCSAccess().getExtPointsAssignment_6_1(), "rule__UcExtendCS__ExtPointsAssignment_6_1");
					put(grammarAccess.getAssocEndCSAccess().getNameAssignment_0(), "rule__AssocEndCS__NameAssignment_0");
					put(grammarAccess.getAssocEndCSAccess().getOwnedTypeAssignment_2(), "rule__AssocEndCS__OwnedTypeAssignment_2");
					put(grammarAccess.getTypedTupeMultiplicityRefCSAccess().getOwnedMultiplicityAssignment_1(), "rule__TypedTupeMultiplicityRefCS__OwnedMultiplicityAssignment_1");
					put(grammarAccess.getActorRefCSAccess().getOwnedPathNameAssignment(), "rule__ActorRefCS__OwnedPathNameAssignment");
					put(grammarAccess.getUsecaseRefCSAccess().getOwnedPathNameAssignment(), "rule__UsecaseRefCS__OwnedPathNameAssignment");
					put(grammarAccess.getStepRefCSAccess().getOwnedPathNameAssignment(), "rule__StepRefCS__OwnedPathNameAssignment");
					put(grammarAccess.getExtensionPointRefCSAccess().getOwnedPathNameAssignment(), "rule__ExtensionPointRefCS__OwnedPathNameAssignment");
					put(grammarAccess.getObjVarRefCSAccess().getOwnedPathNameAssignment(), "rule__ObjVarRefCS__OwnedPathNameAssignment");
					put(grammarAccess.getAssocRefCSAccess().getOwnedPathNameAssignment(), "rule__AssocRefCS__OwnedPathNameAssignment");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.eclipse.sme.frsl.ui.contentassist.antlr.internal.InternalFRSLParser typedParser = (org.eclipse.sme.frsl.ui.contentassist.antlr.internal.InternalFRSLParser) parser;
			typedParser.entryRuleFrslModelCS();
