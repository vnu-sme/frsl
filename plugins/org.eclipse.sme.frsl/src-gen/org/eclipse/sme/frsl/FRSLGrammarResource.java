...
/**
 * FRSLGrammarResource provides a programmatically initialized org.eclipse.sme.frsl.FRSL Grammar model avoiding
 ...
 */
public class FRSLGrammarResource extends AbstractGrammarResource
{
	private static final @NonNull Grammar G_FRSL = createGrammar("org.eclipse.sme.frsl.FRSL");
	...
	/**
	 *	The shared immutable instance of the org.eclipse.sme.frsl.FRSL Grammar resource.
	 */
	public static final @NonNull FRSLGrammarResource INSTANCE = new FRSLGrammarResource();

	/**
	 *	The shared immutable instance of the org.eclipse.sme.frsl.FRSL Grammar model.
	 */
	 ...
	 */
	public static final @NonNull String LANGUAGE_NAME = "org.eclipse.sme.frsl.FRSL";

	protected FRSLGrammarResource() {
		super(URI.createURI(LANGUAGE_NAME));
		List<EObject> contents = getContents();
		contents.add(_FRSL.initGrammar());
	...
	public static class GrammarProvider extends org.eclipse.xtext.service.GrammarProvider
	{
		...
		public Grammar getGrammar(Object requestor) {
			return FRSLGrammarResource.GRAMMAR;
		}
	}
	...
	private static class _FRSL
	{
		...
		private static final @NonNull ReferencedMetamodel MM_oclinEcore = createReferencedMetamodel(org.eclipse.ocl.xtext.oclinecorecs.OCLinEcoreCSPackage.eINSTANCE, "oclinEcore"); // http://www.eclipse.org/ocl/2015/OCLinEcoreCS
		...
		private static final @NonNull ParserRule PR_ActStepCS = createParserRule("ActStepCS", createTypeRef(MM, org.eclipse.sme.frslcs.FrslCSPackage.Literals.ACT_STEP_CS));
		private static final @NonNull ParserRule PR_ActorActionCS = createParserRule("ActorActionCS", createTypeRef(MM, org.eclipse.sme.frslcs.FrslCSPackage.Literals.ACTOR_ACTION_CS));
		private static final @NonNull ParserRule PR_ActorCS = createParserRule("ActorCS", createTypeRef(MM, org.eclipse.sme.frslcs.FrslCSPackage.Literals.ACTOR_CS));
		private static final @NonNull ParserRule PR_ActorRefCS = createParserRule("ActorRefCS", createTypeRef(MM_base, org.eclipse.ocl.xtext.basecs.BaseCSPackage.Literals.MODEL_ELEMENT_REF_CS));
		private static final @NonNull ParserRule PR_ActorStepCS = createParserRule("ActorStepCS", createTypeRef(MM, org.eclipse.sme.frslcs.FrslCSPackage.Literals.ACT_STEP_CS));
		private static final @NonNull ParserRule PR_AltFlowCS = createParserRule("AltFlowCS", createTypeRef(MM, org.eclipse.sme.frslcs.FrslCSPackage.Literals.ALT_FLOW_CS));
		private static final @NonNull ParserRule PR_AssocEndCS = createParserRule("AssocEndCS", createTypeRef(MM_base, org.eclipse.ocl.xtext.basecs.BaseCSPackage.Literals.REFERENCE_CS));
		private static final @NonNull ParserRule PR_AssocRefCS = createParserRule("AssocRefCS", createTypeRef(MM_base, org.eclipse.ocl.xtext.basecs.BaseCSPackage.Literals.MODEL_ELEMENT_REF_CS));
		private static final @NonNull ParserRule PR_AssociationCS = createParserRule("AssociationCS", createTypeRef(MM, org.eclipse.sme.frslcs.FrslCSPackage.Literals.ASSOCIATION_CS));
		private static final @NonNull ParserRule PR_ConstraintCS = createParserRule("ConstraintCS", createTypeRef(MM, org.eclipse.sme.frslcs.FrslCSPackage.Literals.CONSTRAINT_CS));
		private static final @NonNull ParserRule PR_ExtensionPointCS = createParserRule("ExtensionPointCS", createTypeRef(MM, org.eclipse.sme.frslcs.FrslCSPackage.Literals.EXTENSION_POINT_CS));
		private static final @NonNull ParserRule PR_ExtensionPointRefCS = createParserRule("ExtensionPointRefCS", createTypeRef(MM_base, org.eclipse.ocl.xtext.basecs.BaseCSPackage.Literals.MODEL_ELEMENT_REF_CS));
		private static final @NonNull ParserRule PR_FrslModelCS = createParserRule("FrslModelCS", createTypeRef(MM, org.eclipse.sme.frslcs.FrslCSPackage.Literals.FRSL_MODEL_CS));
		private static final @NonNull ParserRule PR_InputActionCS = createParserRule("InputActionCS", createTypeRef(MM, org.eclipse.sme.frslcs.FrslCSPackage.Literals.ACTOR_ACTION_CS));
		private static final @NonNull ParserRule PR_NegObjVarCS = createParserRule("NegObjVarCS", createTypeRef(MM_base, org.eclipse.ocl.xtext.basecs.BaseCSPackage.Literals.MODEL_ELEMENT_REF_CS));
		private static final @NonNull ParserRule PR_ObjVarCS = createParserRule("ObjVarCS", createTypeRef(MM, org.eclipse.sme.frslcs.FrslCSPackage.Literals.OBJ_VAR_CS));
		private static final @NonNull ParserRule PR_ObjVarRefCS = createParserRule("ObjVarRefCS", createTypeRef(MM_base, org.eclipse.ocl.xtext.basecs.BaseCSPackage.Literals.MODEL_ELEMENT_REF_CS));
		private static final @NonNull ParserRule PR_OutputActionCS = createParserRule("OutputActionCS", createTypeRef(MM, org.eclipse.sme.frslcs.FrslCSPackage.Literals.SYSTEM_ACTION_CS));
		private static final @NonNull ParserRule PR_RejoinStepCS = createParserRule("RejoinStepCS", createTypeRef(MM, org.eclipse.sme.frslcs.FrslCSPackage.Literals.REJOIN_STEP_CS));
		private static final @NonNull ParserRule PR_SnapshotPatternCS = createParserRule("SnapshotPatternCS", createTypeRef(MM, org.eclipse.sme.frslcs.FrslCSPackage.Literals.SNAPSHOT_PATTERN_CS));
		private static final @NonNull ParserRule PR_StepCS = createParserRule("StepCS", createTypeRef(MM, org.eclipse.sme.frslcs.FrslCSPackage.Literals.STEP_CS));
		private static final @NonNull ParserRule PR_StepRefCS = createParserRule("StepRefCS", createTypeRef(MM_base, org.eclipse.ocl.xtext.basecs.BaseCSPackage.Literals.MODEL_ELEMENT_REF_CS));
		private static final @NonNull ParserRule PR_SystemActionCS = createParserRule("SystemActionCS", createTypeRef(MM, org.eclipse.sme.frslcs.FrslCSPackage.Literals.SYSTEM_ACTION_CS));
		private static final @NonNull ParserRule PR_SystemStepCS = createParserRule("SystemStepCS", createTypeRef(MM, org.eclipse.sme.frslcs.FrslCSPackage.Literals.ACT_STEP_CS));
		private static final @NonNull ParserRule PR_TypedTupeMultiplicityRefCS = createParserRule("TypedTupeMultiplicityRefCS", createTypeRef(MM_base, org.eclipse.ocl.xtext.basecs.BaseCSPackage.Literals.TYPED_REF_CS));
		private static final @NonNull ParserRule PR_UCStepCS = createParserRule("UCStepCS", createTypeRef(MM, org.eclipse.sme.frslcs.FrslCSPackage.Literals.UC_STEP_CS));
		private static final @NonNull ParserRule PR_UcExtendCS = createParserRule("UcExtendCS", createTypeRef(MM, org.eclipse.sme.frslcs.FrslCSPackage.Literals.EXTEND_CS));
		private static final @NonNull ParserRule PR_UsecaseCS = createParserRule("UsecaseCS", createTypeRef(MM, org.eclipse.sme.frslcs.FrslCSPackage.Literals.USECASE_CS));
		private static final @NonNull ParserRule PR_UsecasePostconditionCS = createParserRule("UsecasePostconditionCS", createTypeRef(MM, org.eclipse.sme.frslcs.FrslCSPackage.Literals.USECASE_POSTCONDITION_CS));
		private static final @NonNull ParserRule PR_UsecasePreconditionCS = createParserRule("UsecasePreconditionCS", createTypeRef(MM, org.eclipse.sme.frslcs.FrslCSPackage.Literals.USECASE_PRECONDITION_CS));
		private static final @NonNull ParserRule PR_UsecaseRefCS = createParserRule("UsecaseRefCS", createTypeRef(MM_base, org.eclipse.ocl.xtext.basecs.BaseCSPackage.Literals.MODEL_ELEMENT_REF_CS));
		private static final @NonNull ParserRule PR_VarLinkCS = createParserRule("VarLinkCS", createTypeRef(MM, org.eclipse.sme.frslcs.FrslCSPackage.Literals.VAR_LINK_CS));

		private static void initParserRules() {
			PR_ActStepCS.setAlternatives(
				createAlternatives(
					createRuleCall(PR_ActorStepCS),
					createRuleCall(PR_SystemStepCS)));
			PR_ActorActionCS.setAlternatives(
				createRuleCall(PR_InputActionCS));
			PR_ActorCS.setAlternatives(
				createGroup(
					createKeyword("actor"),
					...
					setCardinality("?", createGroup(
						...
						createKeyword("="),
						createAssignment("description", "=", createRuleCall(_Base.PR_StringLiteral)))),
					createKeyword("end")));
			PR_ActorRefCS.setAlternatives(
				createAssignment("ownedPathName", "=", createRuleCall(_Base.PR_PathNameCS)));
			PR_ActorStepCS.setAlternatives(
				createGroup(
					createAssignment("isActorStep", "?=", createKeyword("actStep")),
					setCardinality("?", createAssignment("name", "=", createRuleCall(_OCLinEcore.PR_UnrestrictedName))),
					setCardinality("?", createGroup(
						createKeyword("description"),
						createKeyword("="),
						createAssignment("description", "=", createRuleCall(_Base.PR_StringLiteral)))),
					createKeyword("from"),
					createAssignment("preSnapshot", "=", createRuleCall(PR_SnapshotPatternCS)),
					createKeyword("to"),
					createAssignment("postSnapshot", "=", createRuleCall(PR_SnapshotPatternCS)),
					setCardinality("?", createGroup(
						createKeyword("actions"),
						setCardinality("*", createAssignment("actions", "+=", createRuleCall(PR_ActorActionCS))))),
					createKeyword("end")));
			PR_AltFlowCS.setAlternatives(
				createGroup(
					createKeyword("altStep"),
					setCardinality("?", createAssignment("name", "=", createRuleCall(_OCLinEcore.PR_UnrestrictedName))),
					createKeyword("at"),
					createAssignment("baseStep", "=", createRuleCall(PR_StepRefCS)),
					setCardinality("?", createGroup(
						createKeyword("description"),
						createKeyword("="),
						createAssignment("description", "=", createRuleCall(_Base.PR_StringLiteral)))),
					createKeyword("when"),
					createAssignment("condition", "=", createRuleCall(PR_SnapshotPatternCS)),
					createKeyword("end"),
					createAssignment("altStep", "=", createRuleCall(PR_StepCS)),
					createKeyword("end")));
			PR_AssocEndCS.setAlternatives(
				createGroup(
					createAssignment("name", "=", createRuleCall(_OCLinEcore.PR_UnrestrictedName)),
					createKeyword(":"),
					createAssignment("ownedType", "=", createRuleCall(PR_TypedTupeMultiplicityRefCS))));
			PR_AssocRefCS.setAlternatives(
				createAssignment("ownedPathName", "=", createRuleCall(_Base.PR_PathNameCS)));
			PR_AssociationCS.setAlternatives(
				createGroup(
					createKeyword("association"),
					createAssignment("name", "=", createRuleCall(_OCLinEcore.PR_UnrestrictedName)),
					createAssignment("assocEnds", "+=", createRuleCall(PR_AssocEndCS)),
					createAssignment("assocEnds", "+=", createRuleCall(PR_AssocEndCS)),
					createKeyword("end")));
			PR_ConstraintCS.setAlternatives(
				createGroup(
					createKeyword("["),
					createAssignment("constrExpr", "=", createRuleCall(_OCLinEcore.PR_SpecificationCS)),
					createKeyword("]")));
			PR_ExtensionPointCS.setAlternatives(
				createGroup(
					createAction(null, null, createTypeRef(MM, org.eclipse.sme.frslcs.FrslCSPackage.Literals.EXTENSION_POINT_CS)),
					createKeyword("extensionPoint"),
					setCardinality("?", createAssignment("name", "=", createRuleCall(_OCLinEcore.PR_UnrestrictedName))),
					setCardinality("?", createGroup(
						createKeyword("at"),
						createKeyword("{"),
						createAssignment("locations", "+=", createRuleCall(PR_StepRefCS)),
						setCardinality("*", createGroup(
							createKeyword("|"),
							createAssignment("locations", "+=", createRuleCall(PR_StepRefCS)))),
						createKeyword("}"))),
					setCardinality("?", createGroup(
						...
						createAssignment("description", "=", createRuleCall(_Base.PR_StringLiteral)))),
					createKeyword("when"),
					setCardinality("?", createAssignment("condition", "=", createRuleCall(PR_SnapshotPatternCS))),
					createKeyword("end")));
			PR_ExtensionPointRefCS.setAlternatives(
				createAssignment("ownedPathName", "=", createRuleCall(_Base.PR_PathNameCS)));
			PR_FrslModelCS.setAlternatives(
				createGroup(
					createAssignment("domainModel", "=", createRuleCall(_OCLinEcore.PR_TopLevelCS)),
					setCardinality("*", createAssignment("assocs", "+=", createRuleCall(PR_AssociationCS))),
					setCardinality("*", createAssignment("actors", "+=", createRuleCall(PR_ActorCS))),
					setCardinality("*", createAssignment("usecases", "+=", createRuleCall(PR_UsecaseCS))),
					setCardinality("*", createAssignment("ucExtends", "+=", createRuleCall(PR_UcExtendCS)))));
			PR_InputActionCS.setAlternatives(
				createGroup(
					setCardinality("?", createAssignment("actor", "=", createRuleCall(PR_ActorRefCS))),
					createKeyword("->"),
					setCardinality("+", createGroup(
						createAssignment("objVars", "+=", createRuleCall(PR_ObjVarCS)),
						createKeyword(";")))));
			PR_NegObjVarCS.setAlternatives(
				createGroup(
					createKeyword("!"),
					createRuleCall(PR_ObjVarRefCS)));
			PR_ObjVarCS.setAlternatives(
				createGroup(
					setCardinality("?", createAssignment("isMatched", "?=", createKeyword("$"))),
					createAssignment("name", "=", createRuleCall(_OCLinEcore.PR_UnrestrictedName)),
					createKeyword(":"),
					createAssignment("type", "=", createRuleCall(_OCLinEcore.PR_TypedRefCS))));
			PR_ObjVarRefCS.setAlternatives(
				createAssignment("ownedPathName", "=", createRuleCall(_Base.PR_PathNameCS)));
			PR_OutputActionCS.setAlternatives(
				createGroup(
					createAssignment("actor", "=", createRuleCall(PR_ActorRefCS)),
					createKeyword("<-"),
					setCardinality("+", createGroup(
						createAssignment("objVars", "+=", createRuleCall(PR_ObjVarCS)),
						createKeyword("="),
						createAssignment("values", "+=", createRuleCall(_OCLinEcore.PR_SpecificationCS)),
						createKeyword(";")))));
			PR_RejoinStepCS.setAlternatives(
				createGroup(
					createKeyword("rejoinStep"),
					createAssignment("rejoinTo", "=", createRuleCall(PR_StepRefCS)),
					setCardinality("?", createGroup(
						createKeyword("description"),
						createKeyword("="),
						createAssignment("description", "=", createRuleCall(_Base.PR_StringLiteral)))),
					setCardinality("?", createGroup(
						...
						createAssignment("condition", "=", createRuleCall(PR_SnapshotPatternCS)))),
					createKeyword("end")));
			PR_SnapshotPatternCS.setAlternatives(
				createGroup(
					createAction(null, null, createTypeRef(MM, org.eclipse.sme.frslcs.FrslCSPackage.Literals.SNAPSHOT_PATTERN_CS)),
					setCardinality("?", createGroup(
						createKeyword("snapshotID"),
						createKeyword("="),
						createAssignment("name", "=", createRuleCall(_OCLinEcore.PR_UnrestrictedName)))),
					setCardinality("?", createGroup(
						createKeyword("description"),
					...
					setCardinality("*", createGroup(
						createAlternatives(
							createAssignment("objects", "+=", createRuleCall(PR_ObjVarCS)),
							createAssignment("negObjects", "+=", createRuleCall(PR_NegObjVarCS))),
						createKeyword(";"))),
					setCardinality("*", createGroup(
						createAssignment("links", "+=", createRuleCall(PR_VarLinkCS)),
						createKeyword(";"))),
					setCardinality("*", createAssignment("constraints", "+=", createRuleCall(PR_ConstraintCS)))));
			PR_StepCS.setAlternatives(
				createGroup(
					createAlternatives(
						createRuleCall(PR_ActStepCS),
						createRuleCall(PR_RejoinStepCS),
						createRuleCall(PR_UCStepCS)),
					setCardinality("*", createAssignment("altFlows", "+=", createRuleCall(PR_AltFlowCS))),
					setCardinality("?", createAssignment("nextStep", "=", createRuleCall(PR_StepCS)))));
			PR_StepRefCS.setAlternatives(
				createAssignment("ownedPathName", "=", createRuleCall(_Base.PR_PathNameCS)));
			PR_SystemActionCS.setAlternatives(
				createRuleCall(PR_OutputActionCS));
			PR_SystemStepCS.setAlternatives(
				createGroup(
					createKeyword("sysStep"),
					setCardinality("?", createAssignment("name", "=", createRuleCall(_OCLinEcore.PR_UnrestrictedName))),
					setCardinality("?", createGroup(
						createKeyword("description"),
						createKeyword("="),
					...
					setCardinality("?", createGroup(
						createKeyword("actions"),
						setCardinality("*", createAssignment("actions", "+=", createRuleCall(PR_SystemActionCS))))),
					createKeyword("end")));
			PR_TypedTupeMultiplicityRefCS.setAlternatives(
				createGroup(
			...
			PR_UCStepCS.setAlternatives(
				createGroup(
					createKeyword("inclStep"),
					setCardinality("?", createAssignment("name", "=", createRuleCall(_OCLinEcore.PR_UnrestrictedName))),
					setCardinality("?", createGroup(
						createKeyword("description"),
						createKeyword("="),
						createAssignment("description", "=", createRuleCall(_Base.PR_StringLiteral)))),
					createAssignment("includedUC", "=", createRuleCall(PR_UsecaseRefCS)),
					createKeyword("end")));
			PR_UcExtendCS.setAlternatives(
				createGroup(
					createAssignment("extension", "=", createRuleCall(PR_UsecaseRefCS)),
					createKeyword("extends"),
					createAssignment("extendedUC", "=", createRuleCall(PR_UsecaseRefCS)),
					createKeyword("at"),
					createKeyword("{"),
					createAssignment("extPoints", "+=", createRuleCall(PR_ExtensionPointRefCS)),
					setCardinality("*", createGroup(
						createKeyword("|"),
						createAssignment("extPoints", "+=", createRuleCall(PR_ExtensionPointRefCS)))),
					createKeyword("}")));
			PR_UsecaseCS.setAlternatives(
				createGroup(
					createKeyword("usecase"),
					createAssignment("name", "=", createRuleCall(_OCLinEcore.PR_UnrestrictedName)),
					setCardinality("?", createGroup(
						createKeyword("description"),
						createKeyword("="),
						createAssignment("description", "=", createRuleCall(_Base.PR_StringLiteral)))),
					createKeyword("primaryActor"),
					createKeyword("="),
					createAssignment("primaryActor", "=", createRuleCall(PR_ActorRefCS)),
					setCardinality("?", createGroup(
						createKeyword("secondaryActors"),
						createKeyword("="),
						createKeyword("{"),
						createAssignment("secondaryActors", "+=", createRuleCall(PR_ActorRefCS)),
						setCardinality("*", createGroup(
							createKeyword(","),
							createAssignment("secondaryActors", "+=", createRuleCall(PR_ActorRefCS)))),
						createKeyword("}"))),
					setCardinality("?", createAssignment("precondition", "=", createRuleCall(PR_UsecasePreconditionCS))),
					setCardinality("?", createAssignment("postcondition", "=", createRuleCall(PR_UsecasePostconditionCS))),
					createAssignment("firstStep", "=", createRuleCall(PR_StepCS)),
					setCardinality("*", createAssignment("extPoints", "+=", createRuleCall(PR_ExtensionPointCS))),
					createKeyword("end")));
			PR_UsecasePostconditionCS.setAlternatives(
				createGroup(
					createKeyword("ucPostcondition"),
					setCardinality("?", createGroup(
						createKeyword("description"),
						createKeyword("="),
						createAssignment("description", "=", createRuleCall(_Base.PR_StringLiteral)))),
					createAssignment("snapshot", "=", createRuleCall(PR_SnapshotPatternCS)),
					createKeyword("end")));
			PR_UsecasePreconditionCS.setAlternatives(
				createGroup(
					createKeyword("ucPrecondition"),
					setCardinality("?", createGroup(
						createKeyword("description"),
						createKeyword("="),
						createAssignment("description", "=", createRuleCall(_Base.PR_StringLiteral)))),
					createAssignment("snapshot", "=", createRuleCall(PR_SnapshotPatternCS)),
					createKeyword("end")));
			PR_UsecaseRefCS.setAlternatives(
				createAssignment("ownedPathName", "=", createRuleCall(_Base.PR_PathNameCS)));
			PR_VarLinkCS.setAlternatives(
				createGroup(
					setCardinality("?", createAssignment("isNeg", "?=", createKeyword("!"))),
					createKeyword("("),
					createAssignment("objVars", "+=", createRuleCall(PR_ObjVarRefCS)),
					createKeyword(","),
					createAssignment("objVars", "+=", createRuleCall(PR_ObjVarRefCS)),
					createKeyword(")"),
					createKeyword(":"),
					createAssignment("assoc", "=", createRuleCall(PR_AssocRefCS))));
		}

		private static @NonNull Grammar initGrammar() {
			initParserRules();
			Grammar grammar = G_FRSL;
			{
				...
				metamodelDeclarations.add(MM_oclinEcore);
				metamodelDeclarations.add(MM);
			}
			{
				List<AbstractRule> rules = grammar.getRules();
				rules.add(PR_FrslModelCS);
				rules.add(PR_UsecaseCS);
				rules.add(PR_UsecasePreconditionCS);
				rules.add(PR_UsecasePostconditionCS);
				rules.add(PR_StepCS);
				rules.add(PR_ActStepCS);
				rules.add(PR_ActorStepCS);
				rules.add(PR_SystemStepCS);
				rules.add(PR_ActorActionCS);
				rules.add(PR_SystemActionCS);
				rules.add(PR_InputActionCS);
				rules.add(PR_OutputActionCS);
				rules.add(PR_RejoinStepCS);
				rules.add(PR_UCStepCS);
				rules.add(PR_AltFlowCS);
				rules.add(PR_SnapshotPatternCS);
				rules.add(PR_ObjVarCS);
				rules.add(PR_NegObjVarCS);
				rules.add(PR_VarLinkCS);
				rules.add(PR_AssociationCS);
				rules.add(PR_ConstraintCS);
				rules.add(PR_ActorCS);
				rules.add(PR_ExtensionPointCS);
				rules.add(PR_UcExtendCS);
				rules.add(PR_AssocEndCS);
				rules.add(PR_TypedTupeMultiplicityRefCS);
				rules.add(PR_ActorRefCS);
				rules.add(PR_UsecaseRefCS);
				rules.add(PR_StepRefCS);
				rules.add(PR_ExtensionPointRefCS);
				rules.add(PR_ObjVarRefCS);
				rules.add(PR_AssocRefCS);
			}
			{
				List<Grammar> usedGrammars = grammar.getUsedGrammars();
				usedGrammars.add(G_OCLinEcore);
			}
			return grammar;
		}
	}
