...
*/
    ...
    public InternalFRSLParser(TokenStream input, FRSLGrammarAccess grammarAccess) {
        this(input);
    ...
    protected String getFirstRuleName() {
   	...
   	@Override
   	protected FRSLGrammarAccess getGrammarAccess() {
...
entryRuleFrslModelCS returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getFrslModelCSRule()); }
	 iv_ruleFrslModelCS=ruleFrslModelCS
	 { $current=$iv_ruleFrslModelCS.current; }
	 EOF
;

// Rule FrslModelCS
ruleFrslModelCS returns [EObject current=null]
    @init { enterRule();
    }
    @after { leaveRule(); }:
((
(
		{
	        newCompositeNode(grammarAccess.getFrslModelCSAccess().getDomainModelTopLevelCSParserRuleCall_0_0());
	    }
		lv_domainModel_0_0=ruleTopLevelCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getFrslModelCSRule());
	        }
       		set(
       			$current,
       			"domainModel",
        		lv_domainModel_0_0,
        		"org.eclipse.ocl.xtext.oclinecore.OCLinEcore.TopLevelCS");
...
(
		{
	        newCompositeNode(grammarAccess.getFrslModelCSAccess().getAssocsAssociationCSParserRuleCall_1_0());
	    }
		lv_assocs_1_0=ruleAssociationCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getFrslModelCSRule());
	        }
       		add(
       			...
       			"assocs",
        		lv_assocs_1_0,
        		"org.eclipse.sme.frsl.FRSL.AssociationCS");
	        afterParserOrEnumRuleCall();
	    }
...
(
		{
	        newCompositeNode(grammarAccess.getFrslModelCSAccess().getActorsActorCSParserRuleCall_2_0());
	    }
		lv_actors_2_0=ruleActorCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getFrslModelCSRule());
	        }
       		add(
       			...
       			"actors",
        		lv_actors_2_0,
        		"org.eclipse.sme.frsl.FRSL.ActorCS");
	        afterParserOrEnumRuleCall();
	    }
...
(
		{
	        newCompositeNode(grammarAccess.getFrslModelCSAccess().getUsecasesUsecaseCSParserRuleCall_3_0());
	    }
		lv_usecases_3_0=ruleUsecaseCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getFrslModelCSRule());
	        }
       		add(
       			...
       			"usecases",
        		lv_usecases_3_0,
        		"org.eclipse.sme.frsl.FRSL.UsecaseCS");
	        afterParserOrEnumRuleCall();
	    }
...
(
		{
	        newCompositeNode(grammarAccess.getFrslModelCSAccess().getUcExtendsUcExtendCSParserRuleCall_4_0());
	    }
		lv_ucExtends_4_0=ruleUcExtendCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getFrslModelCSRule());
	        }
       		add(
       			...
       			"ucExtends",
        		lv_ucExtends_4_0,
        		"org.eclipse.sme.frsl.FRSL.UcExtendCS");
	        afterParserOrEnumRuleCall();
	    }
...
entryRuleUsecaseCS returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getUsecaseCSRule()); }
	 iv_ruleUsecaseCS=ruleUsecaseCS
	 { $current=$iv_ruleUsecaseCS.current; }
	 EOF
;

// Rule UsecaseCS
ruleUsecaseCS returns [EObject current=null]
    @init { enterRule();
    }
    @after { leaveRule(); }:
(	otherlv_0='usecase'
    {
    	newLeafNode(otherlv_0, grammarAccess.getUsecaseCSAccess().getUsecaseKeyword_0());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getUsecaseCSAccess().getNameUnrestrictedNameParserRuleCall_1_0());
	    }
		lv_name_1_0=ruleUnrestrictedName		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getUsecaseCSRule());
	        }
       		set(
       			$current,
       			"name",
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getUsecaseCSAccess().getDescriptionKeyword_2_0());
    }
	otherlv_3='='
    {
    	newLeafNode(otherlv_3, grammarAccess.getUsecaseCSAccess().getEqualsSignKeyword_2_1());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getUsecaseCSAccess().getDescriptionStringLiteralParserRuleCall_2_2_0());
	    }
...
))?	otherlv_5='primaryActor'
    {
    	newLeafNode(otherlv_5, grammarAccess.getUsecaseCSAccess().getPrimaryActorKeyword_3());
    }
	otherlv_6='='
    {
    	newLeafNode(otherlv_6, grammarAccess.getUsecaseCSAccess().getEqualsSignKeyword_4());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getUsecaseCSAccess().getPrimaryActorActorRefCSParserRuleCall_5_0());
	    }
		lv_primaryActor_7_0=ruleActorRefCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getUsecaseCSRule());
	        }
       		set(
       			...
       			"primaryActor",
        		lv_primaryActor_7_0,
        		"org.eclipse.sme.frsl.FRSL.ActorRefCS");
	        afterParserOrEnumRuleCall();
	    }

)
)(	otherlv_8='secondaryActors'
    {
    	newLeafNode(otherlv_8, grammarAccess.getUsecaseCSAccess().getSecondaryActorsKeyword_6_0());
    }
	otherlv_9='='
    {
    	newLeafNode(otherlv_9, grammarAccess.getUsecaseCSAccess().getEqualsSignKeyword_6_1());
    }
	otherlv_10='{'
    {
    	newLeafNode(otherlv_10, grammarAccess.getUsecaseCSAccess().getLeftCurlyBracketKeyword_6_2());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getUsecaseCSAccess().getSecondaryActorsActorRefCSParserRuleCall_6_3_0());
	    }
		lv_secondaryActors_11_0=ruleActorRefCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getUsecaseCSRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_12, grammarAccess.getUsecaseCSAccess().getCommaKeyword_6_4_0());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getUsecaseCSAccess().getSecondaryActorsActorRefCSParserRuleCall_6_4_1_0());
	    }
		lv_secondaryActors_13_0=ruleActorRefCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getUsecaseCSRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_14, grammarAccess.getUsecaseCSAccess().getRightCurlyBracketKeyword_6_5());
    }
)?(
(
		{
	        newCompositeNode(grammarAccess.getUsecaseCSAccess().getPreconditionUsecasePreconditionCSParserRuleCall_7_0());
	    }
		lv_precondition_15_0=ruleUsecasePreconditionCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getUsecaseCSRule());
	        }
       		set(
        		...
        		"org.eclipse.sme.frsl.FRSL.UsecasePreconditionCS");
	        afterParserOrEnumRuleCall();
	    }
...
(
		{
	        newCompositeNode(grammarAccess.getUsecaseCSAccess().getPostconditionUsecasePostconditionCSParserRuleCall_8_0());
	    }
		lv_postcondition_16_0=ruleUsecasePostconditionCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getUsecaseCSRule());
	        }
       		set(
        		...
        		"org.eclipse.sme.frsl.FRSL.UsecasePostconditionCS");
	        afterParserOrEnumRuleCall();
	    }
...
(
		{
	        newCompositeNode(grammarAccess.getUsecaseCSAccess().getFirstStepStepCSParserRuleCall_9_0());
	    }
		lv_firstStep_17_0=ruleStepCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getUsecaseCSRule());
	        }
       		set(
       			...
       			"firstStep",
        		lv_firstStep_17_0,
        		"org.eclipse.sme.frsl.FRSL.StepCS");
	        afterParserOrEnumRuleCall();
	    }
...
(
		{
	        newCompositeNode(grammarAccess.getUsecaseCSAccess().getExtPointsExtensionPointCSParserRuleCall_10_0());
	    }
		lv_extPoints_18_0=ruleExtensionPointCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getUsecaseCSRule());
	        }
       		add(
       			...
       			"extPoints",
        		lv_extPoints_18_0,
        		"org.eclipse.sme.frsl.FRSL.ExtensionPointCS");
	        afterParserOrEnumRuleCall();
	    }
    ...
    {
    	newLeafNode(otherlv_19, grammarAccess.getUsecaseCSAccess().getEndKeyword_11());
    }
)
;
...
entryRuleUsecasePreconditionCS returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getUsecasePreconditionCSRule()); }
	 iv_ruleUsecasePreconditionCS=ruleUsecasePreconditionCS
	 { $current=$iv_ruleUsecasePreconditionCS.current; }
	 EOF
;

// Rule UsecasePreconditionCS
ruleUsecasePreconditionCS returns [EObject current=null]
    @init { enterRule();
    }
    @after { leaveRule(); }:
(	otherlv_0='ucPrecondition'
    {
    	newLeafNode(otherlv_0, grammarAccess.getUsecasePreconditionCSAccess().getUcPreconditionKeyword_0());
    }
(	otherlv_1='description'
    {
    	newLeafNode(otherlv_1, grammarAccess.getUsecasePreconditionCSAccess().getDescriptionKeyword_1_0());
    }
	otherlv_2='='
    {
    	newLeafNode(otherlv_2, grammarAccess.getUsecasePreconditionCSAccess().getEqualsSignKeyword_1_1());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getUsecasePreconditionCSAccess().getDescriptionStringLiteralParserRuleCall_1_2_0());
	    }
		lv_description_3_0=ruleStringLiteral		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getUsecasePreconditionCSRule());
	        }
       		set(
       			$current,
       			"description",
...
(
		{
	        newCompositeNode(grammarAccess.getUsecasePreconditionCSAccess().getSnapshotSnapshotPatternCSParserRuleCall_2_0());
	    }
		lv_snapshot_4_0=ruleSnapshotPatternCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getUsecasePreconditionCSRule());
	        }
       		set(
       			...
       			"snapshot",
        		lv_snapshot_4_0,
        		"org.eclipse.sme.frsl.FRSL.SnapshotPatternCS");
	        afterParserOrEnumRuleCall();
	    }
    ...
    {
    	newLeafNode(otherlv_5, grammarAccess.getUsecasePreconditionCSAccess().getEndKeyword_3());
    }
)
;
...
entryRuleUsecasePostconditionCS returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getUsecasePostconditionCSRule()); }
	 iv_ruleUsecasePostconditionCS=ruleUsecasePostconditionCS
	 { $current=$iv_ruleUsecasePostconditionCS.current; }
	 EOF
;

// Rule UsecasePostconditionCS
ruleUsecasePostconditionCS returns [EObject current=null]
    @init { enterRule();
    }
    @after { leaveRule(); }:
(	otherlv_0='ucPostcondition'
    {
    	newLeafNode(otherlv_0, grammarAccess.getUsecasePostconditionCSAccess().getUcPostconditionKeyword_0());
    }
(	otherlv_1='description'
    {
    	newLeafNode(otherlv_1, grammarAccess.getUsecasePostconditionCSAccess().getDescriptionKeyword_1_0());
    }
	otherlv_2='='
    {
    	newLeafNode(otherlv_2, grammarAccess.getUsecasePostconditionCSAccess().getEqualsSignKeyword_1_1());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getUsecasePostconditionCSAccess().getDescriptionStringLiteralParserRuleCall_1_2_0());
	    }
		lv_description_3_0=ruleStringLiteral		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getUsecasePostconditionCSRule());
	        }
       		set(
       			$current,
       			"description",
...
(
		{
	        newCompositeNode(grammarAccess.getUsecasePostconditionCSAccess().getSnapshotSnapshotPatternCSParserRuleCall_2_0());
	    }
		lv_snapshot_4_0=ruleSnapshotPatternCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getUsecasePostconditionCSRule());
    ...
    {
    	newLeafNode(otherlv_5, grammarAccess.getUsecasePostconditionCSAccess().getEndKeyword_3());
    }
)
;
...
entryRuleStepCS returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getStepCSRule()); }
	 iv_ruleStepCS=ruleStepCS
	 { $current=$iv_ruleStepCS.current; }
	 EOF
;

// Rule StepCS
ruleStepCS returns [EObject current=null]
    @init { enterRule();
    }
    @after { leaveRule(); }:
((
    ...
    {
        newCompositeNode(grammarAccess.getStepCSAccess().getActStepCSParserRuleCall_0_0());
    }
    this_ActStepCS_0=ruleActStepCS
    {
        $current = $this_ActStepCS_0.current;
        afterParserOrEnumRuleCall();
    }
    ...
    {
        newCompositeNode(grammarAccess.getStepCSAccess().getRejoinStepCSParserRuleCall_0_1());
    }
    this_RejoinStepCS_1=ruleRejoinStepCS
    {
        $current = $this_RejoinStepCS_1.current;
        afterParserOrEnumRuleCall();
    }
    ...
    {
        newCompositeNode(grammarAccess.getStepCSAccess().getUCStepCSParserRuleCall_0_2());
    }
    this_UCStepCS_2=ruleUCStepCS
    {
        $current = $this_UCStepCS_2.current;
        afterParserOrEnumRuleCall();
    }
)(
(
		{
	        newCompositeNode(grammarAccess.getStepCSAccess().getAltFlowsAltFlowCSParserRuleCall_1_0());
	    }
		lv_altFlows_3_0=ruleAltFlowCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getStepCSRule());
	        }
       		add(
       			$current,
       			"altFlows",
        		lv_altFlows_3_0,
        		"org.eclipse.sme.frsl.FRSL.AltFlowCS");
	        afterParserOrEnumRuleCall();
	    }
...
(
		{
	        newCompositeNode(grammarAccess.getStepCSAccess().getNextStepStepCSParserRuleCall_2_0());
	    }
		lv_nextStep_4_0=ruleStepCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getStepCSRule());
	        }
       		set(
...
entryRuleActStepCS returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getActStepCSRule()); }
	 iv_ruleActStepCS=ruleActStepCS
	 { $current=$iv_ruleActStepCS.current; }
	 EOF
;

// Rule ActStepCS
ruleActStepCS returns [EObject current=null]
    @init { enterRule();
    }
    @after { leaveRule(); }:
(
    ...
    {
        newCompositeNode(grammarAccess.getActStepCSAccess().getActorStepCSParserRuleCall_0());
    }
    this_ActorStepCS_0=ruleActorStepCS
    {
        $current = $this_ActorStepCS_0.current;
        afterParserOrEnumRuleCall();
    }
    ...
    {
        newCompositeNode(grammarAccess.getActStepCSAccess().getSystemStepCSParserRuleCall_1());
    }
    this_SystemStepCS_1=ruleSystemStepCS
    {
        $current = $this_SystemStepCS_1.current;
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleActorStepCS returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getActorStepCSRule()); }
	 iv_ruleActorStepCS=ruleActorStepCS
	 { $current=$iv_ruleActorStepCS.current; }
	 EOF
;

// Rule ActorStepCS
ruleActorStepCS returns [EObject current=null]
    @init { enterRule();
    }
    @after { leaveRule(); }:
((
(
		lv_isActorStep_0_0=	'actStep'
    {
        newLeafNode(lv_isActorStep_0_0, grammarAccess.getActorStepCSAccess().getIsActorStepActStepKeyword_0_0());
    }

	    {
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getActorStepCSRule());
	        }
       		setWithLastConsumed($current, "isActorStep", true, "actStep");
	    }
...
(
		{
	        newCompositeNode(grammarAccess.getActorStepCSAccess().getNameUnrestrictedNameParserRuleCall_1_0());
	    }
		lv_name_1_0=ruleUnrestrictedName		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getActorStepCSRule());
	        }
       		set(
       			$current,
       			"name",
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getActorStepCSAccess().getDescriptionKeyword_2_0());
    }
	otherlv_3='='
    {
    	newLeafNode(otherlv_3, grammarAccess.getActorStepCSAccess().getEqualsSignKeyword_2_1());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getActorStepCSAccess().getDescriptionStringLiteralParserRuleCall_2_2_0());
	    }
		lv_description_4_0=ruleStringLiteral		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getActorStepCSRule());
    ...
    {
    	newLeafNode(otherlv_5, grammarAccess.getActorStepCSAccess().getFromKeyword_3());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getActorStepCSAccess().getPreSnapshotSnapshotPatternCSParserRuleCall_4_0());
	    }
		lv_preSnapshot_6_0=ruleSnapshotPatternCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getActorStepCSRule());
	        }
       		set(
    ...
    {
    	newLeafNode(otherlv_7, grammarAccess.getActorStepCSAccess().getToKeyword_5());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getActorStepCSAccess().getPostSnapshotSnapshotPatternCSParserRuleCall_6_0());
	    }
		lv_postSnapshot_8_0=ruleSnapshotPatternCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getActorStepCSRule());
	        }
       		set(
    ...
    {
    	newLeafNode(otherlv_9, grammarAccess.getActorStepCSAccess().getActionsKeyword_7_0());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getActorStepCSAccess().getActionsActorActionCSParserRuleCall_7_1_0());
	    }
		lv_actions_10_0=ruleActorActionCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getActorStepCSRule());
	        }
       		add(
       			...
       			"actions",
        		lv_actions_10_0,
        		"org.eclipse.sme.frsl.FRSL.ActorActionCS");
	        afterParserOrEnumRuleCall();
	    }
    ...
    {
    	newLeafNode(otherlv_11, grammarAccess.getActorStepCSAccess().getEndKeyword_8());
    }
)
;
...
entryRuleSystemStepCS returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getSystemStepCSRule()); }
	 iv_ruleSystemStepCS=ruleSystemStepCS
	 { $current=$iv_ruleSystemStepCS.current; }
	 EOF
;

// Rule SystemStepCS
ruleSystemStepCS returns [EObject current=null]
    @init { enterRule();
    }
    @after { leaveRule(); }:
(	otherlv_0='sysStep'
    {
    	newLeafNode(otherlv_0, grammarAccess.getSystemStepCSAccess().getSysStepKeyword_0());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getSystemStepCSAccess().getNameUnrestrictedNameParserRuleCall_1_0());
	    }
		lv_name_1_0=ruleUnrestrictedName		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getSystemStepCSRule());
	        }
       		set(
       			$current,
       			"name",
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getSystemStepCSAccess().getDescriptionKeyword_2_0());
    }
	otherlv_3='='
    {
    	newLeafNode(otherlv_3, grammarAccess.getSystemStepCSAccess().getEqualsSignKeyword_2_1());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getSystemStepCSAccess().getDescriptionStringLiteralParserRuleCall_2_2_0());
	    }
		lv_description_4_0=ruleStringLiteral		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getSystemStepCSRule());
    ...
    {
    	newLeafNode(otherlv_5, grammarAccess.getSystemStepCSAccess().getFromKeyword_3());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getSystemStepCSAccess().getPreSnapshotSnapshotPatternCSParserRuleCall_4_0());
	    }
		lv_preSnapshot_6_0=ruleSnapshotPatternCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getSystemStepCSRule());
    ...
    {
    	newLeafNode(otherlv_7, grammarAccess.getSystemStepCSAccess().getToKeyword_5());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getSystemStepCSAccess().getPostSnapshotSnapshotPatternCSParserRuleCall_6_0());
	    }
		lv_postSnapshot_8_0=ruleSnapshotPatternCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getSystemStepCSRule());
    ...
    {
    	newLeafNode(otherlv_9, grammarAccess.getSystemStepCSAccess().getActionsKeyword_7_0());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getSystemStepCSAccess().getActionsSystemActionCSParserRuleCall_7_1_0());
	    }
		lv_actions_10_0=ruleSystemActionCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getSystemStepCSRule());
	        }
       		add(
       			...
       			"actions",
        		lv_actions_10_0,
        		"org.eclipse.sme.frsl.FRSL.SystemActionCS");
	        afterParserOrEnumRuleCall();
	    }
    ...
    {
    	newLeafNode(otherlv_11, grammarAccess.getSystemStepCSAccess().getEndKeyword_8());
    }
)
;
...
entryRuleActorActionCS returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getActorActionCSRule()); }
	 iv_ruleActorActionCS=ruleActorActionCS
	 { $current=$iv_ruleActorActionCS.current; }
	 EOF
;

// Rule ActorActionCS
ruleActorActionCS returns [EObject current=null]
    @init { enterRule();
    }
    @after { leaveRule(); }:
    ...
    {
        newCompositeNode(grammarAccess.getActorActionCSAccess().getInputActionCSParserRuleCall());
    }
    this_InputActionCS_0=ruleInputActionCS
    {
        $current = $this_InputActionCS_0.current;
        afterParserOrEnumRuleCall();
    }
...
entryRuleSystemActionCS returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getSystemActionCSRule()); }
	 iv_ruleSystemActionCS=ruleSystemActionCS
	 { $current=$iv_ruleSystemActionCS.current; }
	 EOF
;

// Rule SystemActionCS
ruleSystemActionCS returns [EObject current=null]
    @init { enterRule();
    }
    @after { leaveRule(); }:
    ...
    {
        newCompositeNode(grammarAccess.getSystemActionCSAccess().getOutputActionCSParserRuleCall());
    }
    this_OutputActionCS_0=ruleOutputActionCS
    {
        $current = $this_OutputActionCS_0.current;
        afterParserOrEnumRuleCall();
    }
...
entryRuleInputActionCS returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getInputActionCSRule()); }
	 iv_ruleInputActionCS=ruleInputActionCS
	 { $current=$iv_ruleInputActionCS.current; }
	 EOF
;

// Rule InputActionCS
ruleInputActionCS returns [EObject current=null]
    @init { enterRule();
    }
    @after { leaveRule(); }:
((
(
		{
	        newCompositeNode(grammarAccess.getInputActionCSAccess().getActorActorRefCSParserRuleCall_0_0());
	    }
		lv_actor_0_0=ruleActorRefCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getInputActionCSRule());
	        }
       		set(
       			$current,
       			"actor",
    ...
    {
    	newLeafNode(otherlv_1, grammarAccess.getInputActionCSAccess().getHyphenMinusGreaterThanSignKeyword_1());
    }
((
(
		{
	        newCompositeNode(grammarAccess.getInputActionCSAccess().getObjVarsObjVarCSParserRuleCall_2_0_0());
	    }
		lv_objVars_2_0=ruleObjVarCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getInputActionCSRule());
	        }
       		add(
       			...
       			"objVars",
        		lv_objVars_2_0,
        		"org.eclipse.sme.frsl.FRSL.ObjVarCS");
	        afterParserOrEnumRuleCall();
	    }
    ...
    {
    	newLeafNode(otherlv_3, grammarAccess.getInputActionCSAccess().getSemicolonKeyword_2_1());
    }
)+)
;
...
entryRuleOutputActionCS returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getOutputActionCSRule()); }
	 iv_ruleOutputActionCS=ruleOutputActionCS
	 { $current=$iv_ruleOutputActionCS.current; }
	 EOF
;

// Rule OutputActionCS
ruleOutputActionCS returns [EObject current=null]
    @init { enterRule();
    }
    @after { leaveRule(); }:
((
(
		{
	        newCompositeNode(grammarAccess.getOutputActionCSAccess().getActorActorRefCSParserRuleCall_0_0());
	    }
		lv_actor_0_0=ruleActorRefCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getOutputActionCSRule());
	        }
       		set(
       			$current,
       			"actor",
    ...
    {
    	newLeafNode(otherlv_1, grammarAccess.getOutputActionCSAccess().getLessThanSignHyphenMinusKeyword_1());
    }
((
(
		{
	        newCompositeNode(grammarAccess.getOutputActionCSAccess().getObjVarsObjVarCSParserRuleCall_2_0_0());
	    }
		lv_objVars_2_0=ruleObjVarCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getOutputActionCSRule());
    ...
    {
    	newLeafNode(otherlv_3, grammarAccess.getOutputActionCSAccess().getEqualsSignKeyword_2_1());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getOutputActionCSAccess().getValuesSpecificationCSParserRuleCall_2_2_0());
	    }
		lv_values_4_0=ruleSpecificationCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getOutputActionCSRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_5, grammarAccess.getOutputActionCSAccess().getSemicolonKeyword_2_3());
    }
)+)
;
...
entryRuleRejoinStepCS returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getRejoinStepCSRule()); }
	 iv_ruleRejoinStepCS=ruleRejoinStepCS
	 { $current=$iv_ruleRejoinStepCS.current; }
	 EOF
;

// Rule RejoinStepCS
ruleRejoinStepCS returns [EObject current=null]
    @init { enterRule();
    }
    @after { leaveRule(); }:
(	otherlv_0='rejoinStep'
    {
    	newLeafNode(otherlv_0, grammarAccess.getRejoinStepCSAccess().getRejoinStepKeyword_0());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getRejoinStepCSAccess().getRejoinToStepRefCSParserRuleCall_1_0());
	    }
		lv_rejoinTo_1_0=ruleStepRefCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getRejoinStepCSRule());
	        }
       		set(
       			$current,
       			"rejoinTo",
        		lv_rejoinTo_1_0,
        		"org.eclipse.sme.frsl.FRSL.StepRefCS");
	        afterParserOrEnumRuleCall();
	    }
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getRejoinStepCSAccess().getDescriptionKeyword_2_0());
    }
	otherlv_3='='
    {
    	newLeafNode(otherlv_3, grammarAccess.getRejoinStepCSAccess().getEqualsSignKeyword_2_1());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getRejoinStepCSAccess().getDescriptionStringLiteralParserRuleCall_2_2_0());
	    }
		lv_description_4_0=ruleStringLiteral		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getRejoinStepCSRule());
    ...
    {
    	newLeafNode(otherlv_5, grammarAccess.getRejoinStepCSAccess().getWhenKeyword_3_0());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getRejoinStepCSAccess().getConditionSnapshotPatternCSParserRuleCall_3_1_0());
	    }
		lv_condition_6_0=ruleSnapshotPatternCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getRejoinStepCSRule());
	        }
       		set(
    ...
    {
    	newLeafNode(otherlv_7, grammarAccess.getRejoinStepCSAccess().getEndKeyword_4());
    }
)
;
...
entryRuleUCStepCS returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getUCStepCSRule()); }
	 iv_ruleUCStepCS=ruleUCStepCS
	 { $current=$iv_ruleUCStepCS.current; }
	 EOF
;

// Rule UCStepCS
ruleUCStepCS returns [EObject current=null]
    @init { enterRule();
    }
    @after { leaveRule(); }:
(	otherlv_0='inclStep'
    {
    	newLeafNode(otherlv_0, grammarAccess.getUCStepCSAccess().getInclStepKeyword_0());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getUCStepCSAccess().getNameUnrestrictedNameParserRuleCall_1_0());
	    }
		lv_name_1_0=ruleUnrestrictedName		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getUCStepCSRule());
	        }
       		set(
       			$current,
       			"name",
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getUCStepCSAccess().getDescriptionKeyword_2_0());
    }
	otherlv_3='='
    {
    	newLeafNode(otherlv_3, grammarAccess.getUCStepCSAccess().getEqualsSignKeyword_2_1());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getUCStepCSAccess().getDescriptionStringLiteralParserRuleCall_2_2_0());
	    }
		lv_description_4_0=ruleStringLiteral		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getUCStepCSRule());
...
(
		{
	        newCompositeNode(grammarAccess.getUCStepCSAccess().getIncludedUCUsecaseRefCSParserRuleCall_3_0());
	    }
		lv_includedUC_5_0=ruleUsecaseRefCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getUCStepCSRule());
	        }
       		set(
       			...
       			"includedUC",
        		lv_includedUC_5_0,
        		"org.eclipse.sme.frsl.FRSL.UsecaseRefCS");
	        afterParserOrEnumRuleCall();
	    }
    ...
    {
    	newLeafNode(otherlv_6, grammarAccess.getUCStepCSAccess().getEndKeyword_4());
    }
)
;
...
entryRuleAltFlowCS returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getAltFlowCSRule()); }
	 iv_ruleAltFlowCS=ruleAltFlowCS
	 { $current=$iv_ruleAltFlowCS.current; }
	 EOF
;

// Rule AltFlowCS
ruleAltFlowCS returns [EObject current=null]
    @init { enterRule();
    }
    @after { leaveRule(); }:
(	otherlv_0='altStep'
    {
    	newLeafNode(otherlv_0, grammarAccess.getAltFlowCSAccess().getAltStepKeyword_0());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getAltFlowCSAccess().getNameUnrestrictedNameParserRuleCall_1_0());
	    }
		lv_name_1_0=ruleUnrestrictedName		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getAltFlowCSRule());
	        }
       		set(
       			$current,
       			"name",
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getAltFlowCSAccess().getAtKeyword_2());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getAltFlowCSAccess().getBaseStepStepRefCSParserRuleCall_3_0());
	    }
		lv_baseStep_3_0=ruleStepRefCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getAltFlowCSRule());
	        }
       		set(
    ...
    {
    	newLeafNode(otherlv_4, grammarAccess.getAltFlowCSAccess().getDescriptionKeyword_4_0());
    }
	otherlv_5='='
    {
    	newLeafNode(otherlv_5, grammarAccess.getAltFlowCSAccess().getEqualsSignKeyword_4_1());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getAltFlowCSAccess().getDescriptionStringLiteralParserRuleCall_4_2_0());
	    }
		lv_description_6_0=ruleStringLiteral		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getAltFlowCSRule());
	        }
       		set(
    ...
    {
    	newLeafNode(otherlv_7, grammarAccess.getAltFlowCSAccess().getWhenKeyword_5());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getAltFlowCSAccess().getConditionSnapshotPatternCSParserRuleCall_6_0());
	    }
		lv_condition_8_0=ruleSnapshotPatternCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getAltFlowCSRule());
	        }
       		set(
    ...
    {
    	newLeafNode(otherlv_9, grammarAccess.getAltFlowCSAccess().getEndKeyword_7());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getAltFlowCSAccess().getAltStepStepCSParserRuleCall_8_0());
	    }
		lv_altStep_10_0=ruleStepCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getAltFlowCSRule());
	        }
       		set(
    ...
    {
    	newLeafNode(otherlv_11, grammarAccess.getAltFlowCSAccess().getEndKeyword_9());
    }
)
;
...
entryRuleSnapshotPatternCS returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getSnapshotPatternCSRule()); }
	 iv_ruleSnapshotPatternCS=ruleSnapshotPatternCS
	 { $current=$iv_ruleSnapshotPatternCS.current; }
	 EOF
;

// Rule SnapshotPatternCS
ruleSnapshotPatternCS returns [EObject current=null]
    @init { enterRule();
    }
    @after { leaveRule(); }:
((
	...
	}
    {
        $current = forceCreateModelElement(
            grammarAccess.getSnapshotPatternCSAccess().getSnapshotPatternCSAction_0(),
            $current);
    }
)(	otherlv_1='snapshotID'
    {
    	newLeafNode(otherlv_1, grammarAccess.getSnapshotPatternCSAccess().getSnapshotIDKeyword_1_0());
    }
	otherlv_2='='
    {
    	newLeafNode(otherlv_2, grammarAccess.getSnapshotPatternCSAccess().getEqualsSignKeyword_1_1());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getSnapshotPatternCSAccess().getNameUnrestrictedNameParserRuleCall_1_2_0());
	    }
		lv_name_3_0=ruleUnrestrictedName		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getSnapshotPatternCSRule());
	        }
       		set(
       			$current,
       			"name",
    ...
    {
    	newLeafNode(otherlv_4, grammarAccess.getSnapshotPatternCSAccess().getDescriptionKeyword_2_0());
    }
	otherlv_5='='
    {
    	newLeafNode(otherlv_5, grammarAccess.getSnapshotPatternCSAccess().getEqualsSignKeyword_2_1());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getSnapshotPatternCSAccess().getDescriptionStringLiteralParserRuleCall_2_2_0());
	    }
		lv_description_6_0=ruleStringLiteral		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getSnapshotPatternCSRule());
...
(
		{
	        newCompositeNode(grammarAccess.getSnapshotPatternCSAccess().getObjectsObjVarCSParserRuleCall_3_0_0_0());
	    }
		lv_objects_7_0=ruleObjVarCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getSnapshotPatternCSRule());
	        }
       		add(
...
(
		{
	        newCompositeNode(grammarAccess.getSnapshotPatternCSAccess().getNegObjectsNegObjVarCSParserRuleCall_3_0_1_0());
	    }
		lv_negObjects_8_0=ruleNegObjVarCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getSnapshotPatternCSRule());
	        }
       		add(
       			...
       			"negObjects",
        		lv_negObjects_8_0,
        		"org.eclipse.sme.frsl.FRSL.NegObjVarCS");
	        afterParserOrEnumRuleCall();
	    }
    ...
    {
    	newLeafNode(otherlv_9, grammarAccess.getSnapshotPatternCSAccess().getSemicolonKeyword_3_1());
    }
)*((
(
		{
	        newCompositeNode(grammarAccess.getSnapshotPatternCSAccess().getLinksVarLinkCSParserRuleCall_4_0_0());
	    }
		lv_links_10_0=ruleVarLinkCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getSnapshotPatternCSRule());
	        }
       		add(
       			...
       			"links",
        		lv_links_10_0,
        		"org.eclipse.sme.frsl.FRSL.VarLinkCS");
	        afterParserOrEnumRuleCall();
	    }
    ...
    {
    	newLeafNode(otherlv_11, grammarAccess.getSnapshotPatternCSAccess().getSemicolonKeyword_4_1());
    }
)*(
(
		{
	        newCompositeNode(grammarAccess.getSnapshotPatternCSAccess().getConstraintsConstraintCSParserRuleCall_5_0());
	    }
		lv_constraints_12_0=ruleConstraintCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getSnapshotPatternCSRule());
	        }
       		add(
       			...
       			"constraints",
        		lv_constraints_12_0,
        		"org.eclipse.sme.frsl.FRSL.ConstraintCS");
	        afterParserOrEnumRuleCall();
	    }
...
entryRuleObjVarCS returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getObjVarCSRule()); }
	 iv_ruleObjVarCS=ruleObjVarCS
	 { $current=$iv_ruleObjVarCS.current; }
	 EOF
;

// Rule ObjVarCS
ruleObjVarCS returns [EObject current=null]
    @init { enterRule();
    }
    @after { leaveRule(); }:
((
(
		lv_isMatched_0_0=	'$'
    {
        newLeafNode(lv_isMatched_0_0, grammarAccess.getObjVarCSAccess().getIsMatchedDollarSignKeyword_0_0());
    }

	    {
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getObjVarCSRule());
	        }
       		setWithLastConsumed($current, "isMatched", true, "\$");
	    }
...
(
		{
	        newCompositeNode(grammarAccess.getObjVarCSAccess().getNameUnrestrictedNameParserRuleCall_1_0());
	    }
		lv_name_1_0=ruleUnrestrictedName		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getObjVarCSRule());
	        }
       		set(
       			$current,
       			"name",
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getObjVarCSAccess().getColonKeyword_2());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getObjVarCSAccess().getTypeTypedRefCSParserRuleCall_3_0());
	    }
		lv_type_3_0=ruleTypedRefCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getObjVarCSRule());
	        }
       		set(
...
entryRuleNegObjVarCS returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getNegObjVarCSRule()); }
	 iv_ruleNegObjVarCS=ruleNegObjVarCS
	 { $current=$iv_ruleNegObjVarCS.current; }
	 EOF
;

// Rule NegObjVarCS
ruleNegObjVarCS returns [EObject current=null]
    @init { enterRule();
    }
    @after { leaveRule(); }:
(	otherlv_0='!'
    {
    	newLeafNode(otherlv_0, grammarAccess.getNegObjVarCSAccess().getExclamationMarkKeyword_0());
    }
    ...
    {
        newCompositeNode(grammarAccess.getNegObjVarCSAccess().getObjVarRefCSParserRuleCall_1());
    }
    this_ObjVarRefCS_1=ruleObjVarRefCS
    {
        $current = $this_ObjVarRefCS_1.current;
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleVarLinkCS returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getVarLinkCSRule()); }
	 iv_ruleVarLinkCS=ruleVarLinkCS
	 { $current=$iv_ruleVarLinkCS.current; }
	 EOF
;

// Rule VarLinkCS
ruleVarLinkCS returns [EObject current=null]
    @init { enterRule();
    }
    @after { leaveRule(); }:
((
(
		lv_isNeg_0_0=	'!'
    {
        newLeafNode(lv_isNeg_0_0, grammarAccess.getVarLinkCSAccess().getIsNegExclamationMarkKeyword_0_0());
    }

	    {
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getVarLinkCSRule());
	        }
    ...
    {
    	newLeafNode(otherlv_1, grammarAccess.getVarLinkCSAccess().getLeftParenthesisKeyword_1());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getVarLinkCSAccess().getObjVarsObjVarRefCSParserRuleCall_2_0());
	    }
		lv_objVars_2_0=ruleObjVarRefCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getVarLinkCSRule());
	        }
       		add(
       			$current,
       			"objVars",
        		lv_objVars_2_0,
        		"org.eclipse.sme.frsl.FRSL.ObjVarRefCS");
	        afterParserOrEnumRuleCall();
	    }
    ...
    {
    	newLeafNode(otherlv_3, grammarAccess.getVarLinkCSAccess().getCommaKeyword_3());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getVarLinkCSAccess().getObjVarsObjVarRefCSParserRuleCall_4_0());
	    }
		lv_objVars_4_0=ruleObjVarRefCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getVarLinkCSRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_5, grammarAccess.getVarLinkCSAccess().getRightParenthesisKeyword_5());
    }
	otherlv_6=':'
    {
    	newLeafNode(otherlv_6, grammarAccess.getVarLinkCSAccess().getColonKeyword_6());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getVarLinkCSAccess().getAssocAssocRefCSParserRuleCall_7_0());
	    }
		lv_assoc_7_0=ruleAssocRefCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getVarLinkCSRule());
	        }
       		set(
       			...
       			"assoc",
        		lv_assoc_7_0,
        		"org.eclipse.sme.frsl.FRSL.AssocRefCS");
	        afterParserOrEnumRuleCall();
	    }
...
entryRuleAssociationCS returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getAssociationCSRule()); }
	 iv_ruleAssociationCS=ruleAssociationCS
	 { $current=$iv_ruleAssociationCS.current; }
	 EOF
;

// Rule AssociationCS
ruleAssociationCS returns [EObject current=null]
    @init { enterRule();
    }
    @after { leaveRule(); }:
(	otherlv_0='association'
    {
    	newLeafNode(otherlv_0, grammarAccess.getAssociationCSAccess().getAssociationKeyword_0());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getAssociationCSAccess().getNameUnrestrictedNameParserRuleCall_1_0());
	    }
		lv_name_1_0=ruleUnrestrictedName		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getAssociationCSRule());
	        }
       		set(
       			$current,
       			"name",
...
(
		{
	        newCompositeNode(grammarAccess.getAssociationCSAccess().getAssocEndsAssocEndCSParserRuleCall_2_0());
	    }
		lv_assocEnds_2_0=ruleAssocEndCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getAssociationCSRule());
	        }
       		add(
       			...
       			"assocEnds",
        		lv_assocEnds_2_0,
        		"org.eclipse.sme.frsl.FRSL.AssocEndCS");
	        afterParserOrEnumRuleCall();
	    }
...
(
		{
	        newCompositeNode(grammarAccess.getAssociationCSAccess().getAssocEndsAssocEndCSParserRuleCall_3_0());
	    }
		lv_assocEnds_3_0=ruleAssocEndCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getAssociationCSRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_4, grammarAccess.getAssociationCSAccess().getEndKeyword_4());
    }
)
;
...
(	otherlv_0='['
    {
    	newLeafNode(otherlv_0, grammarAccess.getConstraintCSAccess().getLeftSquareBracketKeyword_0());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getConstraintCSAccess().getConstrExprSpecificationCSParserRuleCall_1_0());
	    }
		lv_constrExpr_1_0=ruleSpecificationCS		{
	        if ($current==null) {
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getConstraintCSAccess().getRightSquareBracketKeyword_2());
    }
)
;
...
entryRuleActorCS returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getActorCSRule()); }
	 iv_ruleActorCS=ruleActorCS
	 { $current=$iv_ruleActorCS.current; }
	 EOF
;

// Rule ActorCS
ruleActorCS returns [EObject current=null]
    @init { enterRule();
    }
    @after { leaveRule(); }:
(	otherlv_0='actor'
    {
    	newLeafNode(otherlv_0, grammarAccess.getActorCSAccess().getActorKeyword_0());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getActorCSAccess().getNameUnrestrictedNameParserRuleCall_1_0());
	    }
		lv_name_1_0=ruleUnrestrictedName		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getActorCSRule());
	        }
       		set(
       			$current,
       			"name",
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getActorCSAccess().getDescriptionKeyword_2_0());
    }
	otherlv_3='='
    {
    	newLeafNode(otherlv_3, grammarAccess.getActorCSAccess().getEqualsSignKeyword_2_1());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getActorCSAccess().getDescriptionStringLiteralParserRuleCall_2_2_0());
	    }
		lv_description_4_0=ruleStringLiteral		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getActorCSRule());
    ...
    {
    	newLeafNode(otherlv_5, grammarAccess.getActorCSAccess().getEndKeyword_3());
    }
)
;
...
entryRuleExtensionPointCS returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getExtensionPointCSRule()); }
	 iv_ruleExtensionPointCS=ruleExtensionPointCS
	 { $current=$iv_ruleExtensionPointCS.current; }
	 EOF
;

// Rule ExtensionPointCS
ruleExtensionPointCS returns [EObject current=null]
    @init { enterRule();
    }
    @after { leaveRule(); }:
((
    ...
    {
        $current = forceCreateModelElement(
            grammarAccess.getExtensionPointCSAccess().getExtensionPointCSAction_0(),
            $current);
    }
)	otherlv_1='extensionPoint'
    {
    	newLeafNode(otherlv_1, grammarAccess.getExtensionPointCSAccess().getExtensionPointKeyword_1());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getExtensionPointCSAccess().getNameUnrestrictedNameParserRuleCall_2_0());
	    }
		lv_name_2_0=ruleUnrestrictedName		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getExtensionPointCSRule());
	        }
       		set(
       			$current,
       			"name",
    ...
    {
    	newLeafNode(otherlv_3, grammarAccess.getExtensionPointCSAccess().getAtKeyword_3_0());
    }
	otherlv_4='{'
    {
    	newLeafNode(otherlv_4, grammarAccess.getExtensionPointCSAccess().getLeftCurlyBracketKeyword_3_1());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getExtensionPointCSAccess().getLocationsStepRefCSParserRuleCall_3_2_0());
	    }
		lv_locations_5_0=ruleStepRefCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getExtensionPointCSRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_6, grammarAccess.getExtensionPointCSAccess().getVerticalLineKeyword_3_3_0());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getExtensionPointCSAccess().getLocationsStepRefCSParserRuleCall_3_3_1_0());
	    }
		lv_locations_7_0=ruleStepRefCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getExtensionPointCSRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_8, grammarAccess.getExtensionPointCSAccess().getRightCurlyBracketKeyword_3_4());
    }
)?(	otherlv_9='description'
    {
    	newLeafNode(otherlv_9, grammarAccess.getExtensionPointCSAccess().getDescriptionKeyword_4_0());
    }
	otherlv_10='='
    {
    	newLeafNode(otherlv_10, grammarAccess.getExtensionPointCSAccess().getEqualsSignKeyword_4_1());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getExtensionPointCSAccess().getDescriptionStringLiteralParserRuleCall_4_2_0());
	    }
		lv_description_11_0=ruleStringLiteral		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getExtensionPointCSRule());
	        }
       		set(
    ...
    {
    	newLeafNode(otherlv_12, grammarAccess.getExtensionPointCSAccess().getWhenKeyword_5());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getExtensionPointCSAccess().getConditionSnapshotPatternCSParserRuleCall_6_0());
	    }
		lv_condition_13_0=ruleSnapshotPatternCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getExtensionPointCSRule());
	        }
       		set(
    ...
    {
    	newLeafNode(otherlv_14, grammarAccess.getExtensionPointCSAccess().getEndKeyword_7());
    }
)
;
...
entryRuleUcExtendCS returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getUcExtendCSRule()); }
	 iv_ruleUcExtendCS=ruleUcExtendCS
	 { $current=$iv_ruleUcExtendCS.current; }
	 EOF
;

// Rule UcExtendCS
ruleUcExtendCS returns [EObject current=null]
    @init { enterRule();
    }
    @after { leaveRule(); }:
((
(
		{
	        newCompositeNode(grammarAccess.getUcExtendCSAccess().getExtensionUsecaseRefCSParserRuleCall_0_0());
	    }
		lv_extension_0_0=ruleUsecaseRefCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getUcExtendCSRule());
	        }
       		set(
       			$current,
       			"extension",
    ...
    {
    	newLeafNode(otherlv_1, grammarAccess.getUcExtendCSAccess().getExtendsKeyword_1());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getUcExtendCSAccess().getExtendedUCUsecaseRefCSParserRuleCall_2_0());
	    }
		lv_extendedUC_2_0=ruleUsecaseRefCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getUcExtendCSRule());
	        }
       		set(
    ...
    {
    	newLeafNode(otherlv_3, grammarAccess.getUcExtendCSAccess().getAtKeyword_3());
    }
	otherlv_4='{'
    {
    	newLeafNode(otherlv_4, grammarAccess.getUcExtendCSAccess().getLeftCurlyBracketKeyword_4());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getUcExtendCSAccess().getExtPointsExtensionPointRefCSParserRuleCall_5_0());
	    }
		lv_extPoints_5_0=ruleExtensionPointRefCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getUcExtendCSRule());
	        }
       		add(
       			...
       			"extPoints",
        		lv_extPoints_5_0,
        		"org.eclipse.sme.frsl.FRSL.ExtensionPointRefCS");
	        afterParserOrEnumRuleCall();
	    }
    ...
    {
    	newLeafNode(otherlv_6, grammarAccess.getUcExtendCSAccess().getVerticalLineKeyword_6_0());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getUcExtendCSAccess().getExtPointsExtensionPointRefCSParserRuleCall_6_1_0());
	    }
		lv_extPoints_7_0=ruleExtensionPointRefCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getUcExtendCSRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_8, grammarAccess.getUcExtendCSAccess().getRightCurlyBracketKeyword_7());
    }
)
;
...
entryRuleAssocEndCS returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getAssocEndCSRule()); }
	 iv_ruleAssocEndCS=ruleAssocEndCS
	 { $current=$iv_ruleAssocEndCS.current; }
	 EOF
;

// Rule AssocEndCS
ruleAssocEndCS returns [EObject current=null]
    @init { enterRule();
    }
    @after { leaveRule(); }:
((
(
		{
	        newCompositeNode(grammarAccess.getAssocEndCSAccess().getNameUnrestrictedNameParserRuleCall_0_0());
	    }
		lv_name_0_0=ruleUnrestrictedName		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getAssocEndCSRule());
	        }
       		set(
       			$current,
       			"name",
    ...
    {
    	newLeafNode(otherlv_1, grammarAccess.getAssocEndCSAccess().getColonKeyword_1());
    }
(
(
		{
	        newCompositeNode(grammarAccess.getAssocEndCSAccess().getOwnedTypeTypedTupeMultiplicityRefCSParserRuleCall_2_0());
	    }
		lv_ownedType_2_0=ruleTypedTupeMultiplicityRefCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getAssocEndCSRule());
	        }
       		set(
       			...
       			"ownedType",
        		lv_ownedType_2_0,
        		"org.eclipse.sme.frsl.FRSL.TypedTupeMultiplicityRefCS");
	        afterParserOrEnumRuleCall();
	    }
...
entryRuleTypedTupeMultiplicityRefCS returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getTypedTupeMultiplicityRefCSRule()); }
	 iv_ruleTypedTupeMultiplicityRefCS=ruleTypedTupeMultiplicityRefCS
	 { $current=$iv_ruleTypedTupeMultiplicityRefCS.current; }
	 EOF
;

// Rule TypedTupeMultiplicityRefCS
ruleTypedTupeMultiplicityRefCS returns [EObject current=null]
    @init { enterRule();
    }
    @after { leaveRule(); }:
(
    ...
    {
        newCompositeNode(grammarAccess.getTypedTupeMultiplicityRefCSAccess().getTypedTypeRefCSParserRuleCall_0());
    }
...
(
		{
	        newCompositeNode(grammarAccess.getTypedTupeMultiplicityRefCSAccess().getOwnedMultiplicityMultiplicityCSParserRuleCall_1_0());
	    }
		lv_ownedMultiplicity_1_0=ruleMultiplicityCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getTypedTupeMultiplicityRefCSRule());
	        }
       		set(
       			$current,
       			"ownedMultiplicity",
...
entryRuleActorRefCS returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getActorRefCSRule()); }
	 iv_ruleActorRefCS=ruleActorRefCS
	 { $current=$iv_ruleActorRefCS.current; }
	 EOF
;

// Rule ActorRefCS
ruleActorRefCS returns [EObject current=null]
    @init { enterRule();
    }
    @after { leaveRule(); }:
(
(
		{
	        newCompositeNode(grammarAccess.getActorRefCSAccess().getOwnedPathNamePathNameCSParserRuleCall_0());
	    }
		lv_ownedPathName_0_0=rulePathNameCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getActorRefCSRule());
	        }
       		set(
       			$current,
       			"ownedPathName",
...
entryRuleUsecaseRefCS returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getUsecaseRefCSRule()); }
	 iv_ruleUsecaseRefCS=ruleUsecaseRefCS
	 { $current=$iv_ruleUsecaseRefCS.current; }
	 EOF
;

// Rule UsecaseRefCS
ruleUsecaseRefCS returns [EObject current=null]
    @init { enterRule();
    }
    @after { leaveRule(); }:
(
(
		{
	        newCompositeNode(grammarAccess.getUsecaseRefCSAccess().getOwnedPathNamePathNameCSParserRuleCall_0());
	    }
		lv_ownedPathName_0_0=rulePathNameCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getUsecaseRefCSRule());
	        }
       		set(
       			$current,
       			"ownedPathName",
...
entryRuleStepRefCS returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getStepRefCSRule()); }
	 iv_ruleStepRefCS=ruleStepRefCS
	 { $current=$iv_ruleStepRefCS.current; }
	 EOF
;

// Rule StepRefCS
ruleStepRefCS returns [EObject current=null]
    @init { enterRule();
    }
    @after { leaveRule(); }:
(
(
		{
	        newCompositeNode(grammarAccess.getStepRefCSAccess().getOwnedPathNamePathNameCSParserRuleCall_0());
	    }
		lv_ownedPathName_0_0=rulePathNameCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getStepRefCSRule());
	        }
       		set(
       			$current,
       			"ownedPathName",
...
entryRuleExtensionPointRefCS returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getExtensionPointRefCSRule()); }
	 iv_ruleExtensionPointRefCS=ruleExtensionPointRefCS
	 { $current=$iv_ruleExtensionPointRefCS.current; }
	 EOF
;

// Rule ExtensionPointRefCS
ruleExtensionPointRefCS returns [EObject current=null]
    @init { enterRule();
    }
    @after { leaveRule(); }:
(
(
		{
	        newCompositeNode(grammarAccess.getExtensionPointRefCSAccess().getOwnedPathNamePathNameCSParserRuleCall_0());
	    }
		lv_ownedPathName_0_0=rulePathNameCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getExtensionPointRefCSRule());
	        }
       		set(
       			$current,
       			"ownedPathName",
...
entryRuleObjVarRefCS returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getObjVarRefCSRule()); }
	 iv_ruleObjVarRefCS=ruleObjVarRefCS
	 { $current=$iv_ruleObjVarRefCS.current; }
	 EOF
;

// Rule ObjVarRefCS
ruleObjVarRefCS returns [EObject current=null]
    @init { enterRule();
    }
    @after { leaveRule(); }:
(
(
		{
	        newCompositeNode(grammarAccess.getObjVarRefCSAccess().getOwnedPathNamePathNameCSParserRuleCall_0());
	    }
		lv_ownedPathName_0_0=rulePathNameCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getObjVarRefCSRule());
	        }
       		set(
       			$current,
       			"ownedPathName",
...
entryRuleAssocRefCS returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getAssocRefCSRule()); }
	 iv_ruleAssocRefCS=ruleAssocRefCS
	 { $current=$iv_ruleAssocRefCS.current; }
	 EOF
;

// Rule AssocRefCS
ruleAssocRefCS returns [EObject current=null]
    @init { enterRule();
    }
    @after { leaveRule(); }:
(
(
		{
	        newCompositeNode(grammarAccess.getAssocRefCSAccess().getOwnedPathNamePathNameCSParserRuleCall_0());
	    }
		lv_ownedPathName_0_0=rulePathNameCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getAssocRefCSRule());
	        }
       		set(
       			$current,
       			"ownedPathName",
