...
public abstract class AbstractFRSLSyntacticSequencer extends AbstractSyntacticSequencer {

	protected FRSLGrammarAccess grammarAccess;
	protected AbstractElementAlias match_ActorStepCS_ActionsKeyword_7_0_q;
	...
	protected AbstractElementAlias match_SystemStepCS_ActionsKeyword_7_0_q;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (FRSLGrammarAccess) access;
		match_ActorStepCS_ActionsKeyword_7_0_q = new TokenAlias(false, true, grammarAccess.getActorStepCSAccess().getActionsKeyword_7_0());
		...
		match_SystemStepCS_ActionsKeyword_7_0_q = new TokenAlias(false, true, grammarAccess.getSystemStepCSAccess().getActionsKeyword_7_0());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if (match_ActorStepCS_ActionsKeyword_7_0_q.equals(syntax))
				emit_ActorStepCS_ActionsKeyword_7_0_q(semanticObject, getLastNavigableState(), syntaxNodes);
			...
			else if (match_SystemStepCS_ActionsKeyword_7_0_q.equals(syntax))
				emit_SystemStepCS_ActionsKeyword_7_0_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     postSnapshot=SnapshotPatternCS (ambiguity) 'end' (rule end)
	 *     postSnapshot=SnapshotPatternCS (ambiguity) 'end' altFlows+=AltFlowCS
	 *     postSnapshot=SnapshotPatternCS (ambiguity) 'end' nextStep=StepCS
	 */
	protected void emit_ActorStepCS_ActionsKeyword_7_0_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
	 ...
	 *     postSnapshot=SnapshotPatternCS (ambiguity) 'end' nextStep=StepCS
	 */
	protected void emit_SystemStepCS_ActionsKeyword_7_0_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
